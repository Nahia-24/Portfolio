        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-5xl font-bold mb-4 bg-gradient-to-r from-blue-300 to-cyan-400 bg-clip-text text-transparent">
                  Get in Touch
                </h2>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">nahiayeseniamontoyasanchez@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">Cali, Valle del Cauca 760001</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative backdrop-blur-lg bg-[var(--card-bg)] p-8 rounded-2xl shadow-xl">
              ...
              <div className="absolute top-7 right-5 p-2 z-11">
                <SparklesText/>
              </div>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-300 to-cyan-400 text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity"
                >
